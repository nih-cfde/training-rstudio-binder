...
You can install the complete tidyverse with a single line of code: `install.packages("tidyverse")`. It is a good idea to "comment out" this line of code by adding a `#` at the beginning so that you don't re-install the package every time you run the script.  
```{r  eval=FALSE}
