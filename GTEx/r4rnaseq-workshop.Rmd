...
Now you know a handful of R functions for importing, summarizing, and visualizing data. In the next secion, we will tidy and tranform our data so that we can make even better summaries and figures.  
