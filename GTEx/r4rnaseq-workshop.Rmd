...
After installing packages, we need to load the functions and tools we want to use from the package with the `library()` command. Let's install the following packages: `ggplot2, tidyr, dplyr, readr, and tibble`. 
