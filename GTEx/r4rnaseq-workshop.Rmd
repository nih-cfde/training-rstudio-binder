...
By the end of today's workshop, you will be able to create tables and plots like the ones below. These plots give a nice overview of the samples collected and the variables that can be used for differential gene expression analysis. 
