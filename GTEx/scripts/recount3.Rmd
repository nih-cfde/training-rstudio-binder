...
countDatawith <- colnames(countData)
countDatawithout <- gsub(".1$", "", countDatawith)
head(countDatawithout)


colDatawith <- colData$SAMPID
colDatawithout <- gsub(".1$", "", colDatawith)
head(colDatawithout)

genesversinowith <- row.names(countData)
genesversinowithout <- gsub(".1$", "", genesversinowith)
head(genesversinowithout)


colnames(countData) <- countDatawithout
rownames(countData) <- genesversinowithout
rownames(colData) <- colDatawithout
colData$SAMPID <- colDatawithout
